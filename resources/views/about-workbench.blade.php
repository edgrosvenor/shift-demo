<x-app-layout>
    <main class="min-h-full bg-cover bg-top sm:bg-top"
          style="background-image: url('https://images.unsplash.com/photo-1534398079543-7ae6d016b86a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80')">
        <div class="px-4 py-16 lg:px-8 lg:pt-24">
            <h1 class="mt-2 text-4xl font-bold tracking-tight text-gray-100 sm:text-5xl">About Workbench</h1>
            <div class="h-96 my-12 text-white text-2xl bg-gray-300 bg-opacity-20 py-4 rounded-lg pl-12 space-y-12">
                <p>Workbench is a desktop app that lets you run shifts on your own computer using Docker.</p>
                <p>I use Workbench for lots of code quality improvements like adding typehints, which I'll demonstrate tonight.</p>
            </div>
            ...
            <div class="mt-6 mx-auto text-center">
                ...
                <a href="{{ route('about-workbench') }}"
                   class="inline-flex items-center rounded-md border bg-gray-300 px-4 py-2 text-sm font-medium text-black">About Workbench</a>
